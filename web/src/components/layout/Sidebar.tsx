...
import { Database, Search, Table2, Share2, Settings, Home, Terminal, Rows3, Globe, StickyNote, Palette, Bell, Shield, KeyRound, ArrowLeft, Sliders, Users, Activity, BookOpen } from 'lucide-react';
    ...
    <aside className="w-64 flex flex-col border-r" style={{ backgroundColor: 'var(--bgSecondary)', borderColor: 'var(--borderDefault)' }}>
      <div className="p-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs" style={{ color: 'var(--textMuted)' }}>Studio</p>
        </div>
      </div>
